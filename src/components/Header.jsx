...
const Header = () => {
  ...
  return (
    <div
      className="fixed top-0 w-full left-0 z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90
      lg:backdrop-blur-sm"
    >
      <div className="flex items-center px-5 lg:px7.5 xl:px-10 max-lg:py-4">
        ...
        <nav className=" fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg-flex lg:mx lg:mx-auto lg:bg-transparent">
            ...
            {navigation.map((item) => (
              <a
                ...
                className={`block relative font-code text-2xl 
                  uppercase text-n-1 
                  transition-color hover:text-color-1 ${item.onlyMobile ? 'lg:hidden' : ''}
